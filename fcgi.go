...
func (req *Request) Param(str string) string {
	return req.env[str];
}
func (req *Request) Data() io.Reader {
	return io.Reader(req.data);
}
func (req *Request) Stdin() io.Reader {
	return io.Reader(req.stdin);
}
